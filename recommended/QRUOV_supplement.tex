...
cross-checks.  Later appendices give the direct-forgery proofs, expanded-key
certificate calculations, seeded expansion, optional identification with the
planted oil space, alternative low-space directions, and executable
pseudocode.  These details are separated so that readers can understand the
attack and its parameter implications before entering the full audit.

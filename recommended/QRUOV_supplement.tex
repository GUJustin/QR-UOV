...
cross-checks.  Later appendices give the expanded-key certificate calculations,
seeded expansion, optional identification with the planted oil space,
alternative low-space directions, and executable pseudocode.  These details
are separated so that readers can understand the attack and its parameter
implications before entering the full audit.
